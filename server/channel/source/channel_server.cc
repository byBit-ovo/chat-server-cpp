...
int main(int argc, char *argv[])
{
    ...
    MY_IM::ChannelServerBuilder csb;
    ...
    csb.make_discoverer_object(FLAGS_registry_host, FLAGS_base_service, FLAGS_transmite_service);
    csb.make_rpc_server(FLAGS_listen_port, FLAGS_rpc_timeout, FLAGS_rpc_threads);
    csb.make_registry_object(FLAGS_registry_host, FLAGS_base_service + FLAGS_instance_name, FLAGS_access_host);
