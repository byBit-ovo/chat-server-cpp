...
namespace MY_IM
{
	class MessageServiceImpl : public MY_IM::MsgStorageService
	{
	public:
		MessageServiceImpl(
		...
		virtual void GetHistoryMsg(::google::protobuf::RpcController *controller,
								   const ::MY_IM::GetHistoryMsgReq *request,
								   ::MY_IM::GetHistoryMsgRsp *response,
		...
		virtual void GetRecentMsg(::google::protobuf::RpcController *controller,
								  const ::MY_IM::GetRecentMsgReq *request,
								  ::MY_IM::GetRecentMsgRsp *response,
								  ::google::protobuf::Closure *done)
		{
			brpc::ClosureGuard rpc_guard(done);
			auto err_response = [this, response](const std::string &rid,
			...
			// 2. get meta_data of recent messages from MySQL 
			...
			// 4. get user_data through user_service 
		...
		virtual void MsgSearch(::google::protobuf::RpcController *controller,
							   const ::MY_IM::MsgSearchReq *request,
							   ::MY_IM::MsgSearchRsp *response,
							   ::google::protobuf::Closure *done)
		{
			brpc::ClosureGuard rpc_guard(done);
			auto err_response = [this, response](const std::string &rid,
	...
	public:
		...
		MessageServer(const MQClient::ptr &mq_client,
					  const Discoverer::ptr service_discoverer,
