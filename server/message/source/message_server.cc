...
DEFINE_string(mq_user, "qzr", "消息队列服务器访问用户名");
DEFINE_string(mq_pswd, "200533", "消息队列服务器访问密码");
...
int main(int argc, char *argv[])
{
    ...
    MY_IM::MessageServerBuilder msb;
    ...
    msb.make_discoverer_object(FLAGS_registry_host, FLAGS_base_service, FLAGS_file_service, FLAGS_user_service);
