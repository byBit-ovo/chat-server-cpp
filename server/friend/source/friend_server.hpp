...
namespace MY_IM{
class FriendServiceImpl : public MY_IM::FriendService {
    public:
        FriendServiceImpl(
        ...
        virtual void FriendRemove(::google::protobuf::RpcController* controller,
            const ::MY_IM::FriendRemoveReq* request,
            ::MY_IM::FriendRemoveRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAdd(::google::protobuf::RpcController* controller,
            const ::MY_IM::FriendAddReq* request,
            ::MY_IM::FriendAddRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendAddProcess(::google::protobuf::RpcController* controller,
            const ::MY_IM::FriendAddProcessReq* request,
            ::MY_IM::FriendAddProcessRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void FriendSearch(::google::protobuf::RpcController* controller,
            const ::MY_IM::FriendSearchReq* request,
            ::MY_IM::FriendSearchRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetPendingFriendEventList(::google::protobuf::RpcController* controller,
            const ::MY_IM::GetPendingFriendEventListReq* request,
            ::MY_IM::GetPendingFriendEventListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetChatSessionList(::google::protobuf::RpcController* controller,
            const ::MY_IM::GetChatSessionListReq* request,
            ::MY_IM::GetChatSessionListRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void ChatSessionCreate(::google::protobuf::RpcController* controller,
            const ::MY_IM::ChatSessionCreateReq* request,
            ::MY_IM::ChatSessionCreateRsp* response,
            ::google::protobuf::Closure* done) {
            brpc::ClosureGuard rpc_guard(done);
            //1. 定义错误回调
            auto err_response = [this, response](const std::string &rid, 
