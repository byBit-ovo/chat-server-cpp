...
namespace MY_IM{
class TransmiteServiceImpl : public MY_IM::MsgTransmitService {
    public:
        ...
        void GetTransmitTarget(google::protobuf::RpcController* controller,
                       ...
                       ::MY_IM::GetTransmitTargetRsp* response,
...
class TransmiteServer {
    public:
        ...
        TransmiteServer(
            const std::shared_ptr<odb::core::database> &mysql_client,
            const Discoverer::ptr discoverer_client,
    ...
    public:
        ...
        TransmiteServer::ptr build() {
            ...
            TransmiteServer::ptr server = std::make_shared<TransmiteServer>(
                _mysql_client, _service_discoverer, _register_client, _rpc_server);
            return server;
        }
    private:
        std::string _user_service_name;
