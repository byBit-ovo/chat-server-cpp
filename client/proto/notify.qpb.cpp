...
UserInfo &NotifyFriendAddApply::mutUserInfo() &
{
    dptr.detach();
    return *dptr->m_userInfo;
}
...
UserInfo &NotifyFriendAddProcess::mutUserInfo() &
{
    dptr.detach();
    return *dptr->m_userInfo;
}
...
ChatSessionInfo &NotifyNewChatSession::mutChatSessionInfo() &
{
    dptr.detach();
    return *dptr->m_chatSessionInfo;
}
...
MessageInfo &NotifyNewMessage::mutMessageInfo() &
{
    dptr.detach();
    return *dptr->m_messageInfo;
}
