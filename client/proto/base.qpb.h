...
class UserInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class ChatSessionInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class StringMessageInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class ImageMessageInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class FileMessageInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
    Q_PROPERTY(QString fileId READ fileId_p WRITE setFileId_p)
    Q_PROPERTY(bool hasFileId READ hasFileId)
...
class SpeechMessageInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
    Q_PROPERTY(QString fileId READ fileId_p WRITE setFileId_p)
    Q_PROPERTY(bool hasFileId READ hasFileId)
...
class MessageContent final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class MessageInfo final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class FileDownloadData final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
...
class FileUploadData final : public QProtobufMessage
{
    Q_PROTOBUF_OBJECT
    Q_PROPERTY(QString fileName READ fileName WRITE setFileName SCRIPTABLE true)
    Q_PROPERTY(QtProtobuf::int64 fileSize READ fileSize WRITE setFileSize SCRIPTABLE false)
